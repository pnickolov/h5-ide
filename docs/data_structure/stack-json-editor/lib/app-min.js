...
var ajax = function () {
    function e(e, t, o, i, r) {
        try {
            ...
            if (n.onreadystatechange = function () {
                ...
                for (var a in i) i.hasOwnProperty(a) && n.setRequestHeader(a, i[a]);
            n.send(o)
        } catch (l) {
            r(l, 0)
        }
    ...
    FileRetriever = function (e) {
        ...
        }, this.scriptUrl = e.scriptUrl || "fileretriever.php", this.notify = e.notify || void 0, this.defaultFilename = "stack-template.json", this.dom = {}
    };
FileRetriever.prototype._hide = function (e) {
    ...
    if (!t) {
        var o = 500,
            i = 5,
            r = document.body.offsetWidth || window.innerWidth;
...
app.CodeToTree = function () {
    ...
    try {
        ...
        //load json from file. add by xjimmy
        var filename = "stack-template.json";
    ...
    if (d && (s -= d + l), app.splitter) {
        ...
        if (c)
            ...
            } else h = s * p - f, n.innerHTML = "&lsaquo;", n.title = "Drag left to show the tree editor";
            else h = 0, n.innerHTML = "&rsaquo;", n.title = "Drag right to show the code editor";
        o.style.display = 0 == p ? "none" : "", o.style.width = Math.max(Math.round(h), 0) + "px", codeEditor.resize(), n.style.height = i.clientHeight - r.clientHeight - 2 * l - (m ? l : 0) + "px", n.style.lineHeight = n.style.height, t.style.display = 1 == p ? "none" : "", t.style.left = Math.round(h + f) + "px", t.style.width = Math.max(Math.round(s - h - f - 2), 0) + "px"
    }
