define(['ApiRequestDefs'], function( ApiRequestDefs ){
	var Apis = {
		...
		'ami_CreateImage'                        : { type:'aws', url:'/aws/ec2/ami/',	method:'CreateImage',	params:['username', 'session_id', 'project_id', 'key_id', 'region_name', 'instance_id', 'ami_name', 'ami_desc', 'no_reboot', 'bd_mappings']   },
		...
		'ins_BundleInstance'                     : { type:'aws', url:'/aws/ec2/instance/',	method:'BundleInstance',	params:['username', 'session_id', 'project_id', 'key_id', 'region_name', 'instance_id', 's3_bucket', 's3_prefix', 's3_access_key', 's3_upload_policy', 's3_upload_policy_signature']   },
		...
		'kp_upload'                              : { type:'aws', url:'/aws/ec2/keypair/',	method:'upload',	params:['username', 'session_id', 'project_id', 'region_name', 'key_name', 'key_data']   },
		'kp_download'                            : { type:'aws', url:'/aws/ec2/keypair/',	method:'download',	params:['username', 'session_id', 'project_id', 'region_name', 'key_name']   },
