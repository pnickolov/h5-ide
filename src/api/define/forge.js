define(['ApiRequestDefs'], function( ApiRequestDefs ){
	var Apis = {
		...
		'app_update'              : { type:'forge', url:'/app/',	method:'update',	params:['username', 'session_id', 'key_id', 'region_name', 'spec', 'app_id', 'fast_update', 'create_snapshot', 'release_eip', 'dry_run']   },
		'app_rename'              : { type:'forge', url:'/app/',	method:'rename',	params:['username', 'session_id', 'region_name', 'app_id', 'new_name', 'app_name']   },
		'app_terminate'           : { type:'forge', url:'/app/',	method:'terminate',	params:['username', 'session_id', 'key_id', 'region_name', 'app_id', 'app_name', 'flag', 'create_snapshot', 'release_eip']   },
		...
		'stack_run'               : { type:'forge', url:'/stack/',	method:'run',	params:['username', 'session_id', 'key_id', 'region_name', 'stack', 'app_name', 'dry_run']   },
