define(['ApiRequestDefs'], function( ApiRequestDefs ){
	var Apis = {
		...
		'os_quota_Info'                        : { type:'openstack', url:'/os/cinder/v2_0/quota/',	method:'Info',	params:['username', 'session_id', 'region', 'quota_tenant_id']   },
		'os_quota_Update'                      : { type:'openstack', url:'/os/cinder/v2_0/quota/',	method:'Update',	params:['username', 'session_id', 'region', 'quota_tenant_id', 'quota']   },
		'os_quota_Delete'                      : { type:'openstack', url:'/os/cinder/v2_0/quota/',	method:'Delete',	params:['username', 'session_id', 'region', 'quota_tenant_id']   },
		'os_quota_GetUserQuota'                : { type:'openstack', url:'/os/cinder/v2_0/quota/',	method:'GetUserQuota',	params:['uesrname', 'session_id', 'region', 'quota_tenant_id', 'user_id', 'is_detail']   },
		'os_quota_UpdateUserQuota'             : { type:'openstack', url:'/os/cinder/v2_0/quota/',	method:'UpdateUserQuota',	params:['uesrname', 'session_id', 'region', 'quota_tenant_id', 'user_id', 'quota']   },
		'os_quota_DeleteUserQuota'             : { type:'openstack', url:'/os/cinder/v2_0/quota/',	method:'DeleteUserQuota',	params:['uesrname', 'session_id', 'region', 'quota_tenant_id', 'user_id']   },
