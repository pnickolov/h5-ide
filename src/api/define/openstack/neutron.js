define(['ApiRequestDefs'], function( ApiRequestDefs ){
	var Apis = {
		...
		'os_securitygroup_List'                : { type:'openstack', url:'/os/neutron/v2_0/sg/',	method:'List',	params:['username', 'session_id', 'region']   },
		'os_securitygroup_Info'                : { type:'openstack', url:'/os/neutron/v2_0/sg/',	method:'Info',	params:['username', 'session_id', 'region', 'sg_ids']   },
		'os_securitygroup_ListSecurityGroupRule' : { type:'openstack', url:'/os/neutron/v2_0/sg/',	method:'ListSecurityGroupRule',	params:['username', 'session_id', 'region', 'sg_rule_id']   },
