define(['ApiRequestDefs'], function( ApiRequestDefs ){
	var Apis = {
		...
		'os_neutron_quota_List'                : { type:'openstack', url:'/os/neutron/v2_0/quota/',	method:'List',	params:['username', 'session_id', 'region', 'quota_tenant_id']   },
		'os_neutron_quota_Info'                : { type:'openstack', url:'/os/neutron/v2_0/quota/',	method:'Info',	params:['username', 'session_id', 'region', 'quota_tenant_id', 'user_ids']   },
