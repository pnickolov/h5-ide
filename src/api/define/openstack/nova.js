define(['ApiRequestDefs'], function( ApiRequestDefs ){
	var Apis = {
		...
		'os_hypervisor_Info'                   : { type:'openstack', url:'/os/nova/v2_0/hypervisor/',	method:'Info',	params:['username', 'session_id', 'region', 'hypervisor_hostname', 'list_servers']   },
		'os_hypervisor_Statistics'             : { type:'openstack', url:'/os/nova/v2_0/hypervisor/',	method:'Statistics',	params:['username', 'session_id', 'region']   },
		'os_image_List'                        : { type:'openstack', url:'/os/nova/v2_0/image/',	method:'List',	params:['username', 'session_id', 'region', 'changes_since', 'server', 'name', 'status', 'marker', 'limit', 'type']   },
		'os_image_Info'                        : { type:'openstack', url:'/os/nova/v2_0/image/',	method:'Info',	params:['username', 'session_id', 'region', 'ids']   },
		'os_image_CreateImageMetadata'         : { type:'openstack', url:'/os/nova/v2_0/image/',	method:'CreateImageMetadata',	params:['username', 'session_id', 'region', 'image_id', 'metadata']   },
		'os_image_GetImageMetadata'            : { type:'openstack', url:'/os/nova/v2_0/image/',	method:'GetImageMetadata',	params:['username', 'session_id', 'region', 'image_id', 'metadata_key']   },
		'os_image_UpdateImageMetadata'         : { type:'openstack', url:'/os/nova/v2_0/image/',	method:'UpdateImageMetadata',	params:['username', 'session_id', 'region', 'image_id', 'metadata']   },
		'os_image_DeleteImageMetadata'         : { type:'openstack', url:'/os/nova/v2_0/image/',	method:'DeleteImageMetadata',	params:['username', 'session_id', 'region', 'image_id', 'metadata_key']   },
		'os_interface_List'                    : { type:'openstack', url:'/os/nova/v2_0/interface/',	method:'List',	params:['username', 'session_id', 'region', 'server_id', 'attachment_id']   },
		...
		'os_keypair_List'                      : { type:'openstack', url:'/os/nova/v2_0/keypair/',	method:'List',	params:['username', 'session_id', 'region', 'keypair_name']   },
		...
		'os_server_GetConsole'                 : { type:'openstack', url:'/os/nova/v2_0/server/',	method:'GetConsole',	params:['username', 'session_id', 'region', 'server_id', 'action', 'specs']   },
