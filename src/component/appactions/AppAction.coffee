  ...
  Backbone.View.extend
    ...
    runStack: ( paymentUpdate, paymentModal )->
      ...
      @modal.on 'confirm', ()=>
        ...
        json = {"id":"stack-ab0b3f5a","region":"us-east-1","provider":"aws::global","time_update":1425733979,"version":"2014-11-11","property":{"stoppable":true},"description":"","resource_diff":true,"agent":{"enabled":true,"module":{"repo":"https://github.com/MadeiraCloud/salt.git","tag":"v2015-02-27"}},"name":"mesos1","component":{"11E8474C-2F77-4ECB-885C-7C091CB512FF":{"name":"vpc","description":"","type":"AWS.VPC.VPC","uid":"11E8474C-2F77-4ECB-885C-7C091CB512FF","resource":{"EnableDnsSupport":true,"InstanceTenancy":"default","EnableDnsHostnames":false,"DhcpOptionsId":"","VpcId":"","CidrBlock":"10.0.0.0/16"}},"FD7B59F0-0E91-4813-9DBF-1F6FB33DE9D5":{"name":"RT-0","description":"","type":"AWS.VPC.RouteTable","uid":"FD7B59F0-0E91-4813-9DBF-1F6FB33DE9D5","resource":{"PropagatingVgwSet":[],"RouteTableId":"","VpcId":"@{11E8474C-2F77-4ECB-885C-7C091CB512FF.resource.VpcId}","AssociationSet":[{"Main":"true","RouteTableAssociationId":"","SubnetId":""}],"RouteSet":[{"Origin":"CreateRouteTable","DestinationCidrBlock":"10.0.0.0/16","InstanceId":"","NetworkInterfaceId":"","GatewayId":"local"}],"Tags":[{"Key":"visops_default","Value":"true"}]}},"2C1993F5-66D7-43E7-B845-1C901C41E32E":{"name":"DefaultACL","type":"AWS.VPC.NetworkAcl","uid":"2C1993F5-66D7-43E7-B845-1C901C41E32E","resource":{"AssociationSet":[],"Default":true,"EntrySet":[{"Egress":true,"Protocol":-1,"RuleAction":"allow","RuleNumber":100,"CidrBlock":"0.0.0.0/0","IcmpTypeCode":{"Code":"","Type":""},"PortRange":{"From":"","To":""}},{"Egress":false,"Protocol":-1,"RuleAction":"allow","RuleNumber":100,"CidrBlock":"0.0.0.0/0","IcmpTypeCode":{"Code":"","Type":""},"PortRange":{"From":"","To":""}},{"Egress":true,"Protocol":-1,"RuleAction":"deny","RuleNumber":32767,"CidrBlock":"0.0.0.0/0","IcmpTypeCode":{"Code":"","Type":""},"PortRange":{"From":"","To":""}},{"Egress":false,"Protocol":-1,"RuleAction":"deny","RuleNumber":32767,"CidrBlock":"0.0.0.0/0","IcmpTypeCode":{"Code":"","Type":""},"PortRange":{"From":"","To":""}}],"NetworkAclId":"","VpcId":"@{11E8474C-2F77-4ECB-885C-7C091CB512FF.resource.VpcId}","Tags":[{"Key":"visops_default","Value":"true"}]}},"9F7FF163-7686-461E-93DC-CCEF1957BC8D":{"name":"DefaultKP","type":"AWS.EC2.KeyPair","uid":"9F7FF163-7686-461E-93DC-CCEF1957BC8D","resource":{"KeyFingerprint":"","KeyName":"DefaultKP"}},"A6E70403-E216-4CAA-8A7E-B8C7219561CC":{"name":"DefaultSG","type":"AWS.EC2.SecurityGroup","uid":"A6E70403-E216-4CAA-8A7E-B8C7219561CC","resource":{"Default":true,"GroupId":"","GroupName":"DefaultSG","GroupDescription":"default VPC security group","VpcId":"@{11E8474C-2F77-4ECB-885C-7C091CB512FF.resource.VpcId}","IpPermissions":[{"FromPort":"22","ToPort":"22","IpRanges":"0.0.0.0/0","IpProtocol":"tcp"}],"IpPermissionsEgress":[{"FromPort":"0","ToPort":"65535","IpRanges":"0.0.0.0/0","IpProtocol":"-1"}],"Tags":[{"Key":"visops_default","Value":"true"}]}}},"layout":{"11E8474C-2F77-4ECB-885C-7C091CB512FF":{"coordinate":[5,3],"uid":"11E8474C-2F77-4ECB-885C-7C091CB512FF","size":[60,60]},"FD7B59F0-0E91-4813-9DBF-1F6FB33DE9D5":{"coordinate":[50,5],"uid":"FD7B59F0-0E91-4813-9DBF-1F6FB33DE9D5","groupUId":"11E8474C-2F77-4ECB-885C-7C091CB512FF"},"size":[240,240]}}
        @workspace.opsModel.run(json, "mesos1").then ( ops )->
          self.modal.close()
          App.loadUrl ops.url()
        , (err)->
          self.modal.close()
