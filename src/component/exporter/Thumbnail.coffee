  ...
  exportPNG = ( $svg_canvas_element, data ) ->
    ...
    if data.isExport
      ...
      if data.drawInfo isnt false
        ...
        name = data.name
      head = "<g transform='translate(#{origin.x} #{origin.y-54})'><rect fill='#3b1252' width='100%' height='4'></rect><rect fill='#723197' width='100%' height='50' y='4'></rect><image #{Href}='./assets/images/ide/logo-t.png?v=2' x='10' y='8' width='160' height='34'></image><text x='100%' y='40' fill='#fff' text-anchor='end' transform='translate(-10 0)'>#{time}</text><text fill='#fff' x='100%' y='24' text-anchor='end' transform='translate(-10 0)'>#{name}</text></g>"
