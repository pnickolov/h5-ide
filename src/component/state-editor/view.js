...
StateEditorView = Backbone.View.extend({
  ...
  refreshStateView: function($stateItem) {
    ...
    _.each($paraItemList, function(paraItemElem) {
      var $keyInput, $paraItem, $valueInput, keyValue, paraDisabled, paraName, paraObj, paraType, paraValue, valueValue, viewRenderObj;
  ...
  bindParaItemEvent: function($paraItem, paraObj) {
    ...
    } else if (paraType === 'line' || paraType === 'text' || paraType === 'array' || paraType === 'state') {
  ...
  refreshParaList: function($paraListElem, currentCMD) {
    ...
    _.each(currentParaAry, function(paraObj) {
      ...
      if ((_ref = paraObj.type) === 'line' || _ref === 'text' || _ref === 'bool' || _ref === 'state') {
  ...
  saveStateData: function() {
    ...
    _.each($stateItemList, function(stateItem, idx) {
      ...
      _.each($paraItemList, function(paraItem) {
        ...
        paraName = $paraItem.attr('data-para-name');
        paraValue = null;
        if ($paraItem.hasClass('line') || $paraItem.hasClass('bool') || $paraItem.hasClass('text') || $paraItem.hasClass('state')) {
  ...
  loadStateData: function(stateObj) {
    ...
    _.each(stateObj, function(state, stateId) {
      ...
      _.each(paraModelObj, function(paraModelValue, paraModelName) {
        ...
        if (paraModelType === 'line' || paraModelType === 'text' || paraModelType === 'bool' || paraModelType === 'state') {
