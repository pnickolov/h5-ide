	...
	switch (type) {
		...
		case 'AWS.EC2.Instance':
			...
			$(group).append(
				...
				Canvon.image(MC.IMG_URL + 'ide/icon/instance-canvas.png', 15, 9, 61, 62),

				//2 path: left port(blue)
				Canvon.path(MC.canvas.PATH_D_PORT2).attr({
					'class': 'port port-blue port-instance-sg port-instance-sg-left',
					'id' : group.id + '_port-instance-sg-left',
					'transform': 'translate(8, 16)' + MC.canvas.PORT_RIGHT_ROTATE, //port position: right:0 top:-90 left:-180 bottom:-270
				...
				////8.1 volume-attached
				Canvon.image(MC.IMG_URL + 'ide/icon/instance-volume-' + icon_volume_status + '.png' , 21, 44, 29, 24).attr({
					'id': group.id + '_volume_status'
				}),

				//8.2 volume number
				Canvon.text(35, 56, volume_number).attr({
				...
				////hostname bg
				Canvon.rectangle(3, 75, 84, 15).attr({
		...
		case 'AWS.ELB':
			...
			$(group).append(
				...
				Canvon.image(MC.IMG_URL + 'ide/icon/elb-' + icon_scheme + '-canvas.png', 10, 12, 70, 53).attr({
				...
				Canvon.path(MC.canvas.PATH_D_PORT).attr({
					...
					'transform': 'translate(3, 27)' + MC.canvas.PORT_RIGHT_ROTATE,
					'data-name': 'elb-sg-in',
					'data-position': 'left',
					'data-type': 'sg',
					'data-direction': "in",
				...
				Canvon.path(MC.canvas.PATH_D_PORT).attr({
					...
					'transform': 'translate(79, 16)' + MC.canvas.PORT_RIGHT_ROTATE,
				...
				Canvon.path(MC.canvas.PATH_D_PORT).attr({
					...
					'transform': 'translate(79, 43)' + MC.canvas.PORT_RIGHT_ROTATE,
					'data-name': 'elb-assoc',
					'data-position': 'right',
					'data-type': 'association',
					'data-direction': 'out',
				...
				////6. elb_name
				Canvon.text(45, 80, option.name).attr({
					'class': 'node-label name',
		...
		case 'AWS.VPC.NetworkInterface':
			...
			$(group).append(
				...
				Canvon.image(MC.IMG_URL + 'ide/icon/eni-canvas-'+attached+'.png', 16, 18, 58, 49).attr({
				...
				Canvon.path(MC.canvas.PATH_D_PORT2).attr({
					...
					//'display': 'none', //hide
					'transform': 'translate(7, 16)' + MC.canvas.PORT_RIGHT_ROTATE,
					'data-name': 'eni-sg',
					'data-position': 'left',
					'data-type': 'sg',
					'data-direction': "in",
				...
				Canvon.path(MC.canvas.PATH_D_PORT).attr({
					...
					'transform': 'translate(7, 44)' + MC.canvas.PORT_RIGHT_ROTATE,
				...
				Canvon.path(MC.canvas.PATH_D_PORT2).attr({
					...
					//'display': 'none', //hide
					'transform': 'translate(75, 16)' + MC.canvas.PORT_RIGHT_ROTATE,
					'data-name': 'eni-sg',
					'data-position': 'right',
					'data-type': 'sg',
					'data-direction': 'out',
				...
				Canvon.path(MC.canvas.PATH_D_PORT).attr({
					...
					'transform': 'translate(45, 0)' + MC.canvas.PORT_UP_ROTATE,
					'data-name': 'eni-rtb',
					'data-position': 'top',
					'data-type': 'sg',
					'data-direction': 'in',
				...
				Canvon.group().append(
					...
					////child number in group
					Canvon.text(45, 15, option.number).attr({
