define [ 'jquery', 'MC' ], ( $, MC ) ->
	...
	addVPN = (vgwUID, cgwUID) ->
		...
		component_data.resource.VpnGatewayId = MC.aws.aws.genResRef(vgwUID, 'resource.VpnGatewayId')
		component_data.resource.CustomerGatewayId = MC.aws.aws.genResRef(cgwUID, 'resource.CustomerGatewayId')
	...
	delVPN = (vgwUID, cgwUID) ->
		vgw_ref = MC.aws.aws.genResRef(vgwUID, 'resource.VpnGatewayId')
		cgw_ref = MC.aws.aws.genResRef(cgwUID, 'resource.CustomerGatewayId')

		for uid, item of MC.canvas_data.component
