...
define [ 'backbone', 'vpn_service', 'vpn_vo'], ( Backbone, vpn_service, vpn_vo ) ->
    ...
    VPNModel = Backbone.Model.extend {
        ...
        DescribeVpnConnections : ( src, username, session_id, region_name, vpn_ids=null, filters=null ) ->
            ...
            vpn_service.DescribeVpnConnections src, username, session_id, region_name, vpn_ids=null, filters=null, ( aws_result ) ->
