    ...
    loadModule = () ->
        ...
        require [ 'design_view', 'design_model', 'event' ], ( View, model, ide_event ) ->
            ...
            ide_event.onLongListen ide_event.SWITCH_TAB, ( type, tab_id, region_name, result, current_platform ) ->
                ...
                #
                MC.open_failed_list[ tab_id ] = { 'tab_id' : tab_id, 'region' : region_name, 'platform' : current_platform, 'type' : type } if type not in [ 'OLD_STACK', 'OLD_APP' ]
                #
                ...
                #
                ide_event.trigger ide_event.SHOW_DESIGN_OVERLAY, 'OPEN_TAB_FAIL' if type in [ 'OLD_APP' ] and MC.open_failed_list[ tab_id ]
                #test123
