  ...
  IDE:
    ...
    IMPORT_CF_NOTICE:
      en: """  <li>Currently only templates meet following requirements can be imported:</li>
        ...
        <li>For more details, refer to <a href="http://docs.visualops.io/stack/import_cloudformation_template.html" target="_blank" alt="Documentation-Import CloudFormation template">Documentation</a>.</li>"""
      zh: """
        ...
        <li>所有依赖属性将被忽略。</li>
        <li>详情请参看<a href="http://docs.visualops.io/stack/import_cloudformation_template.html" target="_blank" alt="Documentation-Import CloudFormation template">文档</a>。</li>"""
