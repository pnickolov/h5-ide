define({
    ...
    "ide": {
        ...
        "HEAD_WARN_UPDATE_CREDENTIAL": "Cannot change AWS Credentials now since you have unterminated app. If you want to change AWS Credentials, terminate all your apps first.",
        ...
        "HEAD_INFO_CONFIRM_REMOVE": "Do you confirm to remove AWS Credentials of account %s?",
        ...
        "HEAD_TIP_ACCOUNT_ACCESS_KEY": "You will find those keys in Account > Security Credentials menu under Access Keys tab in the box at the middle of the page. e.g., ABCDEFGHIJ1LMNOPQR2S",
        "HEAD_TIP_ACCOUNT_SECRET_KEY": "You will find those keys in Account > Security Credentials menu under Access Keys tab in the box at the middle of the page. e.g., aBCDefgH/ Ijklmnopq1Rs2tUVWXY3AbcDeFGhijk",
        ...
        "POP_BTN_CLOSE": "Close",
        "TA_WARNING_NOT_VPC_CAN_CONNECT_OUTSIDE": "No instance in VPC has Elastic IP, which means this VPC can only connect to outside via VPN",
        "TA_TAKE_POSITION": ""
    },
    "service": {
