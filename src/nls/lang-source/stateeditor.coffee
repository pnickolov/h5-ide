...
##### State Editor
    ...
    STATE_UNKNOWN_DISTRO_LBL:
      ...
      zh: "未识别发行版本的实例，一些 State 模块也许不能在该实例上使用"
    ...
    STATE_HELP_INTRO_LBL:
      ...
      zh: "<p>选择或输入命令，在这里查看相关帮助文档. 详细: <a href='http://docs.visualops.io/state_modules/README.html' target='_blank'>documentation</a>.</p>"
    ...
    INVITE_MOD_REQUEST_CONTENT:
      ...
      zh: "此功能处于实验性质，依然是 Beta 版本，如果您感兴趣，可以免费获取提前预览的邀请"
    ...
    INVITE_MOD_REQUEST_PLACEHOLDER:
      ...
      zh: "告诉我们关于您的用例，以及为何您感兴趣．以帮助我们更快接受您的请求"
