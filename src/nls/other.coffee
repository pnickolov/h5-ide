...
<p>If you launched this instance from your own AMI, the password is the same as for the instance from which you created the AMI, unless this setting was modified in the EC2Config service settings.</p>"
  ...
  ##### Modal Confirm Stop/Terminate App
    ...
    FAILED_TO_CHARGE_YOUR_CREDIT_CARD:
      en: "We were unable to charge for the project. This project is in limited status now. Import VPC, app operation, monitoring and state ensuring are disabled. Update payment information as soon as possible to continue managing apps with VisualOps. "
    ...
    FAILED_TO_CHARGE_YOUR_CREDIT_CARD_MEMBER:
      en: "We were unable to charge for the project. This project is in limited status now. Import VPC, app operation, monitoring and state ensuring are disabled. "
