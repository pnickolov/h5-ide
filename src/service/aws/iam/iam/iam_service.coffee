...
define [ 'MC', 'iam_parser', 'result_vo' ], ( MC, iam_parser, result_vo ) ->
    ...
    GetServerCertificate = ( username, session_id, region_name, servercer_name, callback ) ->
        send_request "GetServerCertificate", [ username, session_id, region_name, servercer_name ], iam_parser.parserGetServerCertificateReturn, callback
        true

    #def ListServerCertificates(self, username, session_id, region_name, marker=None, max_items=None, path_prefix=None):
    ListServerCertificates = ( username, session_id, region_name, marker=null, max_items=null, path_prefix=null, callback ) ->
        send_request "ListServerCertificates", [ username, session_id, region_name, marker, max_items, path_prefix ], iam_parser.parserListServerCertificatesReturn, callback
        true
