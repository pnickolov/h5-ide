...
define [ 'MC', 'optiongroup_parser', 'result_vo' ], ( MC, optiongroup_parser, result_vo ) ->
    ...
    DescribeOptionGroupOptions = ( username, session_id, callback ) ->
        send_request "DescribeOptionGroupOptions", [ username, session_id ], optiongroup_parser.parserDescribeOptionGroupOptionsReturn, callback
        true

    #def DescribeOptionGroups(self, username, session_id, region_name,
    DescribeOptionGroups = ( username, session_id, callback ) ->
        send_request "DescribeOptionGroups", [ username, session_id ], optiongroup_parser.parserDescribeOptionGroupsReturn, callback
        true
