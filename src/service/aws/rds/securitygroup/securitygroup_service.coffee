...
define [ 'MC', 'securitygroup_parser', 'result_vo' ], ( MC, securitygroup_parser, result_vo ) ->
    ...
    DescribeDBSecurityGroups = ( username, session_id, region_name, sg_name=null, marker=null, max_records=null, callback ) ->
        send_request "DescribeDBSecurityGroups", [ username, session_id, region_name, sg_name, marker, max_records ], securitygroup_parser.parserDescribeDBSecurityGroupsReturn, callback
        true
