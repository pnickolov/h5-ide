...
define [ 'MC', 'subnetgroup_parser', 'result_vo' ], ( MC, subnetgroup_parser, result_vo ) ->
    ...
    DescribeDBSubnetGroups = ( src, username, session_id, region_name, sg_name=null, marker=null, max_records=null, callback ) ->
        send_request "DescribeDBSubnetGroups", src, [ username, session_id, region_name, sg_name, marker, max_records ], subnetgroup_parser.parserDescribeDBSubnetGroupsReturn, callback
        true
