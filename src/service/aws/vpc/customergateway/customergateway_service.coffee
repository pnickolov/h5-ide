...
define [ 'MC', 'customergateway_parser', 'result_vo' ], ( MC, customergateway_parser, result_vo ) ->
    ...
    DescribeCustomerGateways = ( src, username, session_id, region_name, gw_ids=null, filters=null, callback ) ->
        send_request "DescribeCustomerGateways", src, [ username, session_id, region_name, gw_ids, filters ], customergateway_parser.parserDescribeCustomerGatewaysReturn, callback
        true
