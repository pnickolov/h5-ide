...
define [ 'MC', 'subnet_parser', 'result_vo' ], ( MC, subnet_parser, result_vo ) ->
    ...
    send_request =  ( api_name, param_ary, parser, callback ) ->
        ...
        try
            ...
            console.log "subnet." + method + " error:" + error.toString()
    ...
    DescribeSubnets = ( username, session_id, region_name, subnet_ids=null, filters=null, callback ) ->
        send_request "DescribeSubnets", [ username, session_id, region_name, subnet_ids, filters ], subnet_parser.parserDescribeSubnetsReturn, callback
        true
