...
define [ 'MC', 'vpngateway_parser', 'result_vo' ], ( MC, vpngateway_parser, result_vo ) ->
    ...
    DescribeVpnGateways = ( username, session_id, region_name, gw_ids=null, filters=null, callback ) ->
        send_request "DescribeVpnGateways", [ username, session_id, region_name, gw_ids, filters ], vpngateway_parser.parserDescribeVpnGatewaysReturn, callback
        true
