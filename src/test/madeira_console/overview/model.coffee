...
define [ 'MC', 'event', 'constant', 'vpc_model',
         ...
         'i18n!/nls/lang.js', 'common_handle', 'aws_handle'], ( MC, ide_event, constant, vpc_model, aws_model, app_model, stack_model, ami_service, elb_service, dhcp_service, vpngateway_service, customergateway_service, lang, common_handle ) ->
