        ...
        setResource : ( resources ) ->
            ...
            if resources.DescribeLoadBalancers
                ...
                _.map resources.DescribeLoadBalancers, ( elb, i ) ->
                    ...
                    createTime = new Date(elb.CreatedTime)
                    elb.CreatedTime = MC.dateFormat(createTime,'yyyy-MM-dd hh:mm:ss') + '(' + MC.intervalDate(createTime/1000) + ')'
            ...
            if resources.DescribeInstances
                ...
                _.map resources.DescribeInstances, ( ins, i ) ->
                    ...
                    launchTime = new Date(ins.launchTime)
                    ins.launchTime = MC.dateFormat(launchTime,'yyyy-MM-dd hh:mm:ss') + '(' + MC.intervalDate(launchTime/1000) + ')'
            ...
            if resources.DescribeVolumes
                ...
                _.map resources.DescribeVolumes, ( vol, i )->
                    ...
                    createTime = new Date(vol.createTime)
                    vol.createTime = MC.dateFormat(createTime,'yyyy-MM-dd hh:mm:ss') + '(' + MC.intervalDate(createTime/1000) + ')'
