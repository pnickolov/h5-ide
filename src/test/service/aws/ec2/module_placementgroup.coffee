...
#* Create date  : 2013-05-29 13:27:43
#* Description  : qunit test module for placementgroup_service
# ************************************************************************************
# (c)Copyright 2012 Madeiracloud  All Rights Reserved
# ************************************************************************************

require [ 'MC', 'jquery', 'test_util', 'session_service', 'placementgroup_service'], ( MC, $, test_util, session_service, placementgroup_service ) ->
    ...
    #aws/ec2 test
    ################################################
    module "Module aws/ec2 - placementgroup"
    #-----------------------------------------------
