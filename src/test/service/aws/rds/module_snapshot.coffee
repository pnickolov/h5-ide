...
require [ 'MC', 'jquery', 'test_util', 'session_service', 'snapshot_service'], ( MC, $, test_util, session_service, snapshot_service ) ->
    ...
    #aws/rds test
    ################################################
    module "Module aws/rds - snapshot"
    #-----------------------------------------------
    ...
    test_DescribeDBSnapshots = () ->
        asyncTest "/aws/rds snapshot.DescribeDBSnapshots()", () ->
            ...
            snapshot_service.DescribeDBSnapshots {sender:this}, username, session_id, ( aws_result ) ->
