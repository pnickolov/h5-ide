...
require [ 'MC', 'jquery', 'test_util', 'session_service', 'acl_service'], ( MC, $, test_util, session_service, acl_service ) ->
    ...
    test_DescribeNetworkAcls = () ->
        asyncTest "/aws/vpc acl.DescribeNetworkAcls()", () ->
            ...
            acl_service.DescribeNetworkAcls {sender:this}, username, session_id, region_name, acl_ids, filters, ( aws_result ) ->
