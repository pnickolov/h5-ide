...
require [ 'MC', 'jquery', 'test_util', 'session_service', 'vpc_service'], ( MC, $, test_util, session_service, vpc_service ) ->
    ...
    test_DescribeVpcs = () ->
        asyncTest "/aws/vpc vpc.DescribeVpcs()", () ->
            ...
            vpc_service.DescribeVpcs {sender:this}, username, session_id, region_name, vpc_ids, filters, ( aws_result ) ->
    ...
    test_DescribeAccountAttributes = () ->
        asyncTest "/aws/vpc vpc.DescribeAccountAttributes()", () ->
            ...
            vpc_service.DescribeAccountAttributes {sender:this}, username, session_id, region_name, attribute_name, ( aws_result ) ->
                if !aws_result.is_error
    ...
    test_DescribeVpcAttribute = () ->
        asyncTest "/aws/vpc vpc.DescribeVpcAttribute()", () ->
            ...
            vpc_service.DescribeVpcAttribute {sender:this}, username, session_id, region_name, vpc_id, attribute, ( aws_result ) ->
                if !aws_result.is_error
