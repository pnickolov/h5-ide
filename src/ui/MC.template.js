...
function program3(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n            <div class=\"modal-footer\">\n                <button id=\"btn-confirm\" class=\"btn btn-blue\">"
    + escapeExpression(((stack1 = (depth0 && depth0.confirm)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</button>\n                ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.closeAble), {hash:{},inverse:self.noop,fn:self.program(4, program4, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </div>\n            ";
  return buffer;
  }
function program4(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "<button id=\"btn-cancel\" class=\"btn modal-close btn-silver\">"
    + escapeExpression(((stack1 = (depth0 && depth0.cancel)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</button>";
  return buffer;
  }

  buffer += "<div id=\"modal-wrap\" class=\"hide\">\n    <div id=\"modal-box\" class=\"\">\n        <div style=\"width: 520px\">\n            <div class=\"modal-header\">\n                <h3>"
    + escapeExpression(((stack1 = (depth0 && depth0.title)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</h3>\n                ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.closeAble), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </div>\n            <div class=\"modal-body scroll-wrap scrollbar-auto-hide context-wrap\" style=\"max-height: 400px;padding: 0;\">\n                <div class=\"scrollbar-veritical-wrap\"><div class=\"scrollbar-veritical-thumb\"></div></div>\n                <div class=\"scroll-content\" style=\"padding: 12px 15px\">\n                    ";
  stack1 = ((stack1 = (depth0 && depth0.template)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                </div>\n            </div>\n            ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.hasFooter), {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n        </div>\n    </div>\n</div>";
  return buffer;
  };
