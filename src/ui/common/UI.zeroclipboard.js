...
(function() {
  ...
  /*
    Move vendor/zeroclipboard here, because this zeroclipboard is a modified version from verndor. ( This version fixes Dom element leaking bug. )
    It should never be updated by automatic scripts
  */

  define( [ 'UI.notification' ],  function () {
