...
This folder contains and only contains testcase(except `./env`) used for automated test before deploying. And should not contain any other things.
...
A pratical example of an testcase is under test/default.coffee. Please use this testcase as an reference if you want to write testcase.
